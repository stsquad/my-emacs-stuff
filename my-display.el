...
(defvar my-nerd-font
  ...
  "Current variant of Nerd Font I'm using.")

(defun my-check-for-nerd-font ()
  "Check if we have the nerd fonts installed."
  (--filter (s-prefix-p my-nerd-font it)
              (font-family-list)))

(if (my-check-for-nerd-font)
